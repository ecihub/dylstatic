...
<iframe frameborder="0"
  ...
  allowfullscreen src="${srcUrl}"></iframe>`;
        ...
        async initImagePlaceholder() {
            ...
            const posterUrlWebp = `https://i.vimeocdn.com/video/${imgId}.webp?mw=382&mh=215&q=70`;
            const posterUrlJpeg = `https://i.vimeocdn.com/video/${imgId}.jpg?mw=382&mh=215&q=70`;
